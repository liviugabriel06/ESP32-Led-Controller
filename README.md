...
După conectarea plăcuței la Wi-Fi, terminalul va afișa adresa IP alocată (ex: 192.168.1.100).

Poți folosi un utilitar precum Packet Sender de pe PC sau telefon:
